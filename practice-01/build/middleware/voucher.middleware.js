...
exports.isVoucherOver = void 0;
var boom_1 = __importDefault(require("@hapi/boom"));
var event_model_1 = require("../models/event.model");
var isVoucherOver = function (request, h) { return __awaiter(void 0, void 0, void 0, function () {
    var event_id, event;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                event_id = request.payload.event_id;
                return [4 /*yield*/, event_model_1.eventModel.findById(event_id)];
            case 1:
                event = _a.sent();
                if (!event)
...
exports.isVoucherOver = isVoucherOver;
